...
public class Birthday {
	...
	JLabel OrignalCost = new JLabel("Orignal Cost For Birthday Function  :");
	...
	JLabel Aprox = new JLabel("Aprox 40,000");
	...
	Press.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
        	...
        	if(bud<=40000)
        	JOptionPane.showMessageDialog(frame,"Budget should be > than 40,000.");
        	else {
