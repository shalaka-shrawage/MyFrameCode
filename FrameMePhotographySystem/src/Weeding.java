...
public class Weeding {
	...
	JLabel data = new JLabel("In this You will get Photos and Videos.");
	data.setBounds(317, 305, 246, 48);
	frame.getContentPane().add(data);
	
	JLabel OrignalCost = new JLabel("Orignal Cost For Weeding Function  :");
	...
	JLabel Aprox = new JLabel("Aprox 50,000");
	...
	Press.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
        	...
        	if(bud<=40000)
            	JOptionPane.showMessageDialog(frame,"Budget should be > than 50,000.");
            	else {
                String op = (String.valueOf(40000-disc));
                valueupdated.setText(op);
            	}
        	
        	if(bud<50000 || bud>40000) {
